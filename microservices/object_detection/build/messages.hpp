...
#ifndef CARLOS_VISION_CAR_HPP
#define CARLOS_VISION_CAR_HPP
...
#include <string>
#include <utility>
namespace carlos { namespace vision {
using namespace std::string_literals; // NOLINT
class LIB_API car {
    private:
        static constexpr const char* TheShortName = "car";
        static constexpr const char* TheLongName = "carlos.vision.car";
    ...
    public:
        ...
        inline car& coc(const float &v) noexcept {
            m_coc = v;
            return *this;
        }
        inline float coc() const noexcept {
            return m_coc;
        }
        
        inline car& area(const float &v) noexcept {
            m_area = v;
            return *this;
        }
        ...
        inline car& queue(const uint16_t &v) noexcept {
            m_queue = v;
            return *this;
        }
        inline uint16_t queue() const noexcept {
            return m_queue;
        }
...
//            visitor.preVisit(ID(), ShortName(), LongName());
            ...
            if (1 == fieldId) {
                doVisit(1, std::move("float"s), std::move("coc"s), m_coc, visitor);
                return;
            }
            
            if (2 == fieldId) {
                doVisit(2, std::move("float"s), std::move("area"s), m_area, visitor);
                return;
            }
            
            if (3 == fieldId) {
                doVisit(3, std::move("uint16_t"s), std::move("queue"s), m_queue, visitor);
                return;
            }
...
//            visitor.postVisit();
        ...
        inline void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            ...
            doTripletForwardVisit(1, std::move("float"s), std::move("coc"s), m_coc, preVisit, visit, postVisit);
            
            doTripletForwardVisit(2, std::move("float"s), std::move("area"s), m_area, preVisit, visit, postVisit);
            
            doTripletForwardVisit(3, std::move("uint16_t"s), std::move("queue"s), m_queue, preVisit, visit, postVisit);
    ...
    private:
        ...
        float m_coc{ 0.0f }; // field identifier = 1.
        
        float m_area{ 0.0f }; // field identifier = 2.
        
        uint16_t m_queue{ 0 }; // field identifier = 3.
        
};
}}

template<>
struct isVisitable<carlos::vision::car> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<carlos::vision::car> {
    static const bool value = true;
};
#endif
...
#ifndef CARLOS_VISION_SIGN_HPP
#define CARLOS_VISION_SIGN_HPP
...
class LIB_API sign {
    private:
        static constexpr const char* TheShortName = "sign";
        static constexpr const char* TheLongName = "carlos.vision.sign";
    ...
    public:
        ...
        inline sign& type(const uint16_t &v) noexcept {
            m_type = v;
            return *this;
        }
        inline uint16_t type() const noexcept {
            return m_type;
        }
        
        inline sign& area(const float &v) noexcept {
            m_area = v;
            return *this;
        }
        inline float area() const noexcept {
...
//            visitor.preVisit(ID(), ShortName(), LongName());
            ...
            if (1 == fieldId) {
                doVisit(1, std::move("uint16_t"s), std::move("type"s), m_type, visitor);
                return;
            }
...
//            visitor.postVisit();
        ...
        inline void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            ...
            doTripletForwardVisit(1, std::move("uint16_t"s), std::move("type"s), m_type, preVisit, visit, postVisit);
    ...
    private:
        ...
        uint16_t m_type{ 0 }; // field identifier = 1.
...
template<>
struct isVisitable<carlos::vision::sign> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<carlos::vision::sign> {
    static const bool value = true;
};
#endif
...
#ifndef CARLOS_COMMAND_HPP
#define CARLOS_COMMAND_HPP
...
class LIB_API command {
    private:
        ...
        static constexpr const char* TheLongName = "carlos.command";
    ...
    public:
        ...
        inline command& type(const uint16_t &v) noexcept {
            m_type = v;
            return *this;
        }
        inline uint16_t type() const noexcept {
...
template<>
struct isVisitable<carlos::command> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<carlos::command> {
    static const bool value = true;
};
#endif
...
#ifndef CARLOS_VISION_OBJECTS_HPP
#define CARLOS_VISION_OBJECTS_HPP
...
namespace carlos { namespace vision {
using namespace std::string_literals; // NOLINT
class LIB_API objects {
    private:
        static constexpr const char* TheShortName = "objects";
        static constexpr const char* TheLongName = "carlos.vision.objects";
    ...
    public:
        ...
        inline objects& nObjects(const uint16_t &v) noexcept {
            m_nObjects = v;
            return *this;
        }
        inline uint16_t nObjects() const noexcept {
            return m_nObjects;
        }
...
//            visitor.preVisit(ID(), ShortName(), LongName());
            ...
            if (1 == fieldId) {
                doVisit(1, std::move("uint16_t"s), std::move("nObjects"s), m_nObjects, visitor);
                return;
            }
...
//            visitor.postVisit();
        ...
        inline void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            ...
            doTripletForwardVisit(1, std::move("uint16_t"s), std::move("nObjects"s), m_nObjects, preVisit, visit, postVisit);
    ...
    private:
        ...
        uint16_t m_nObjects{ 0 }; // field identifier = 1.
        
};
}}

template<>
struct isVisitable<carlos::vision::objects> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<carlos::vision::objects> {
    static const bool value = true;
};
#endif

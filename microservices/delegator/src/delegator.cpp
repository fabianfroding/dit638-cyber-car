...
int32_t main(int32_t argc, char **argv)
{
    ...
    if (carlos_session.isRunning())
    {
        ...
        auto object_sign = [VERBOSE, OBJECT, /* &carlos_session, &LOCK, &UNLOCK, */ &sign_detected, &sign_reached](cluon::data::Envelope &&envelope) {
            /** unpack message recieved*/
        ...
        auto color_intersection = [VERBOSE, COLOR, /* &carlos_session, &LOCK, &UNLOCK, */ &north, &east, &west](cluon::data::Envelope &&envelope) {
            /** unpack message recieved*/
